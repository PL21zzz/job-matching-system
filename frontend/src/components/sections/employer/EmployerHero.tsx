    ...
    <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
      <div className="space-y-8">
        ...
        <p className="text-slate-500 dark:text-gray-400 text-lg leading-relaxed max-w-lg">
          Equitas AI giúp doanh nghiệp xây dựng đội ngũ đa dạng với sức mạnh của
          trí tuệ nhân tạo công bằng, loại bỏ định kiến vô thức trong từng hồ
          sơ.
        </p>
        <div className="flex items-center gap-4">
          <button className="bg-primary hover:bg-primary-hover text-white px-8 py-4 rounded-2xl font-black transition-all shadow-lg shadow-primary/20">
            Bắt đầu ngay
          </button>
          <button className="px-8 py-4 rounded-2xl border-2 border-primary text-primary font-black hover:bg-primary/5 transition-all">
            Tư vấn giải pháp
          </button>
        </div>
      </div>
